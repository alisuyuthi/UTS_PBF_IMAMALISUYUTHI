...
class ProductFactory extends Factory
{
    ...
    {
        return [
            'name' => fake()->randomElement(['Nasi Kecap','Ayam Kecap','Bakso','Pecel', 'Teh Tarik','Es Teh Manis','Kopi Susu', 'Kemeja','Celana Jeans','Jaket','Gaun','Kaus','Kemeja Flanel','Kaos Polo','Rok','Hoodie','Kemeja Batik']),
            ...
            'modified_by' => fake()->randomElement(['ali@gmail.com', 'raju@gmail.com'])
        ];
    }
}
